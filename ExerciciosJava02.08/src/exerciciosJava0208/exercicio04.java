...
*azulejos com as medidas dadas são necessários para cobrir a parede dada.*/
		...
		JOptionPane.showMessageDialog(null,"A quantidade de azulejos necessaria é: " + String.format("%.2f",quantAzu));	
	}
