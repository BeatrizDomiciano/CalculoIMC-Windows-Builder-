...
/*programa para determinar a quantidade de cavalos necessários para se levantar uma massa de m quilogramas  
*a uma altura de h metros em t segundos.*/ 
	    ...
	    JOptionPane.showMessageDialog(null,"A quantidade necessária de Cavalos para carregar \n"
	    		+vet[0]+ " Quilos\n"
	    		+ " a uma distância de "+vet[1]+" de Metros\n"
	    		+ " por "+vet[2]+" segundos é: \n"
